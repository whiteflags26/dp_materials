...
import { Bell, MapPin, Calendar, Share2, X, Bus, FileText, AlertCircle } from 'lucide-react';
...
export default function FacultyDashboard() {
  ...
  const notifications = [
    ...
    },
    {
      id: 2,
      type: 'success',
      message: 'Requisition request for BUET visit approved',
      time: '1 hour ago'
    },
    {
      id: 3,
      type: 'warning',
      message: 'Tomorrow\'s regular trip timing changed to 9:00 AM',
      time: '2 hours ago'
    }
  ];
                        ...
                        <div className="flex justify-between items-start">
                          <div>
                            <div className="flex items-center space-x-2">
                              <Badge variant={trip.type === 'Subscription' ? 'default' : 'secondary'}>
                                {trip.type}
                              </Badge>
